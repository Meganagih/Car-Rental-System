...
<head>
	...
	<title> Deen Car Rental System | Admin Dashboard</title>
...
?>
												...
												<img src="img/user.png" style="width: 120px;height: 120px;margin-left: 90px;margin-top: -50px;">
													<div class="stat-panel-title text-uppercase" style="margin-top: -70px;margin-bottom: 50px;">Register Users</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase" style="margin-top: -70px;margin-bottom: 50px;">Contact-Us</div>
												</div>
											</div>
											<a href="contact_query.php" class="block-anchor panel-footer" style="background: #1980a8a6;border: none;text-align: center;">Full Detail <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
