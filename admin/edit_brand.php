...
$brand=$_POST['brand'];
$id=$_GET['id'];
$sql="update  brands set BrandName=:brand where Brand_id=:id";
...
<head>
	...
	<title>Deen Car Rental System | Admin Edit-Brands</title>
...
color: white;
font-size: 40px;
font-family: initial;">Edit Brand</h2>
...
<?php	
$id=$_GET['id'];
$ret="select * from brands where Brand_id=:id";
