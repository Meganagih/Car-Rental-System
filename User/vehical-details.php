...
<title>Deen Car Rental | Vehicle Details</title>
<!--Bootstrap -->
...
?>
      ...
      <div class="col-md-3">
        <div class="price_info">
         ...
         <div class="price_info" style="margin-top: 30px;border-inline-color:#006e4e">
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <?php if($_SESSION['login'])
              ...
              <?php } else { ?>
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal"> Book</a>
