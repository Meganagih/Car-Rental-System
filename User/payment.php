...
<html lang="en">
<head>
    <title>Deen Car Rental | Payments details</title>
    <style>
...
<body>
    ...
    <div class="row">
      <div class="col-xs-12 col-md-4" style="left: 430px; border-color: #ACD9CF; ">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="card_number" id="card_number" maxlength="16" placeholder="Enter Card Number">
                        ...
                        <div class="col-xs-5 col-md-5 pull-right">
                            <div class="form-group">
                                <label for="expityMonth">
                                    ...
                                    <input type="date" name="exdate" class="form-control" id="expityYear" required style="width: 146px;left: -10px;margin-left: -16px;"/>
                            </div>
                        </div>
                        <div class="col-xs-5 col-md-5 pull-right" style="left:-60px;">
                            <div class="form-group">
                                <label for="cvCode">
                                    CV CODE</label>
                                <input type="password" name="cv" class="form-control" maxlength="3" id="cvCode" placeholder="CV" required />
                            </div>
                        </div>
<br>
<br>
