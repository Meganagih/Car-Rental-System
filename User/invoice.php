<?php 
           session_start();
            ...
            error_reporting(0); //turns off error reporting, suppressing any PHP error messages
...
<html lang="en">
<head>
    <title>Deen Car Rental | Invoice</title>
    <style>
        .text-danger strong {
            color: #9f181c;
        }
        ...
        .receipt-main thead {
            background: #7CB9E8 none repeat scroll 0 0;
        }
                ...
                <div class="receipt-header">
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="receipt-left">
                            <img class="img-responsive" alt="logo" src="assets/images/321.png" style="width: 100px; ;">
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                        <div class="receipt-right">
                            <h5>Deen Car Rental</h5>
                            <p>033-4931931     <i class="fa fa-phone"></i></p>
                            <p>Deencars@gmail.com <i class="fa fa-envelope-o"></i></p>
      ...
      <div class="product-listing-m gray-bg" style="width: 400px;margin-left: -30px;height: 170px;">
          <div class="product-listing-img" style="height: 170px;"><img src="admin/img/vehicleimages/<?php echo htmlentities($_SESSION['Vimage1']);?>" class="img-responsive" alt="Image" style="height: 170px;"/> </a> 
            ...
            <ul>
             ...
             href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>" class="btn">Book /View Details <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
          </div>
      </div>
...
<button class="btn" type="submit" name="send" type="submit"> Print</button>
</div>
<div class="col-md-12" style="float: none; margin: 0 auto; text-align: center;">
