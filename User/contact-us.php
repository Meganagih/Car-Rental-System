...
<title>Deen_Car_Rental | Contact Us</title>
<!--Bootstrap -->
...
.contact-us-bg {
    background-image: url("assets/images/dd.jpeg"); /* Replace with your image path */
...
.contact-us-bg .contact_detail ul li i {
    color: #00008b;
}
        ...
        <div class="contact_detail">
          <ul>
            <li>
              ...
              <h5>Address   :</h5>
              <p> Deen car Rent Kurunegala, Kurunegala</p>
            </li>
            <li>
