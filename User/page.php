...
<title>Deen_Car_Rental | Page details</title>
<!--Bootstrap -->
              ...
              <div class="wpb_column vc_column_container vc_col-sm-12 sc_layouts_column_icons_position_left"><div class="vc_column-inner">
                ...
                <div class="wpb_single_image wpb_content_element vc_align_left">
                  ...
                  <div class="vc_single_image-wrapper   vc_box_border_grey">
                    <img alt="trust wh" title="trust wh" 
                    data-src="https://www.rentalcarsrilanka.com/wp-content/uploads/2020/03/trust-wh-50x50.png" class="vc_single_image-img  lazyloaded" src="https://www.rentalcarsrilanka.com/wp-content/uploads/2020/03/trust-wh-50x50.png" width="50" height="50">
                    <noscript>
                      <img class="vc_single_image-img " 
                      src="https://www.rentalcarsrilanka.com/wp-content/uploads/2020/03/trust-wh-50x50.png" width="50" height="50" alt="trust wh" title="trust wh" />
                    </noscript>
                  </div>
                  </figure>
                  </div>
  ...
  <div class="wpb_wrapper">
    <div class="vc_row wpb_row vc_inner vc_row-fluid box-about">
      <div class="wpb_column vc_column_container vc_col-sm-12 sc_layouts_column_icons_position_left">
        ...
        <div class="wpb_text_column wpb_content_element wpb_animate_when_almost_visible wpb_fadeIn fadeIn wpb_start_animation animated">
          <div class="wpb_wrapper">
            <h3 class="m_title" style="text-align: left;">Safety</h3><p style="text-align: left;font-size: 15px">Choose from our fleet of latest model Japanese vehicles with the best safety features. 
            All Shineway rental car Sri Lanka vehicles are equipped with driver and passenger airbags, seatbelts for all passengers and side collision bars on the doors and much more.</p>
          </div>
        </div>
      </div>
    </div>
